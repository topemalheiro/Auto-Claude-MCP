...
- [x] Queue not moving when task regresses from Progress to Planning and [ ] sending RDR when RDR is ON - needs to be tested. Todo: Might need to have tasks that stop into HR get RDR task toggle offed and/or MCP LLM throws it in Queue"
